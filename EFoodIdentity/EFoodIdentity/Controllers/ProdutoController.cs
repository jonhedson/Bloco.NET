...
using EFoodIdentity.Data;
using EFoodIdentity.Models;
using System.Net.Http;
using System.Net.Http.Headers;
using Newtonsoft.Json;

namespace EFoodIdentity.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            using (var client = new HttpClient())
            {
                ...
                var response = client.GetAsync("api/ProdutoAPI").Result;
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao")] Produto produto)
        {
            if (ModelState.IsValid)
            {
                using (var client = new HttpClient())
                {
                    ...
                    string stringData = JsonConvert.SerializeObject(produto);
                    var contentData = new StringContent(stringData, System.Text.Encoding.UTF8, "application/json");
                    HttpResponseMessage response = client.PostAsync("/api/ProdutoAPI", contentData).Result;
